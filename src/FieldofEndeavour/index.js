...
const ApplicantReview = ({setDetails}) => {
    ...
    <div style={{ width: '100%' }}>
    <TextField rows={5} required multiline fullWidth label='Applicant Performance Details' id="outlined-basic" variant="outlined" onBlur={(e) => setDetails({ projDesc: e.target.value })} />
</div>
